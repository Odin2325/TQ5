...
while eingabe == '':
    ...
    wurfsumme = wurf1 + wurf2 + wurf3

    bonus = 0

    if wurf1 == wurf2 and wurf2 == wurf3:
        bonus = 6
    elif wurf1 == wurf2 or wurf2 == wurf3 or wurf1 == wurf3:
        bonus = 6

    gesamtsumme = wurfsumme + bonus

    print(f'wurf: {wurf1} + {wurf2} + {wurf3} = {wurfsumme}', end='')
    print (f'Bonuspunkte: {bonus}', end='')
    print(f'Gesamtpunkte: {gesamtsumme}')
    ...
    eingabe = input('ENTER für nochmal spielen, q zum Beenden')