...
# noten_liste = student["noten"]

# noten_summe = 0
# for note in noten_liste:
#     noten_summe = noten_summe + note

# noten_anzahl = len(noten_liste)
# durchnitt_note = noten_summe / noten_anzahl
# print(f"{name_of_students} hat eine Gesammtnote {durchnitt_note} !")

# noten_liste = student.get('noten', [])
...
#     print(f"3. Durchschnittsnote: {durchschnitt:.2f}")
#     print("-" * 40)
